namespace GPG.Multiplayer.Client.Vaulting.Mods
{
    ...
    public class PnlModDetailsView : PnlBase
    {
        ...
        public PnlModDetailsView(GPG.Multiplayer.Client.Vaulting.Mods.Mod mod)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.gpgLabel1.Size = new Size(0x292, 0x11);
            ...
            this.gpgLabel4.Size = new Size(0x2d7, 0x11);
            ...
            this.gpgLabel5.Size = new Size(0x2db, 0x11);
            ...
            this.gpgLabelWebsite.Size = new Size(0x248, 15);
            ...
            this.gpgLabel10.Size = new Size(0x2d7, 0x11);
            ...
            this.gpgLabel7.Size = new Size(0x2d7, 0x11);
            ...
            this.gpgPanelRequirements.BackColor = Color.Black;
            ...
            this.gpgPanelRequirements.Size = new Size(0x285, 0x30);
            ...
            this.gpgPanelConflicts.BackColor = Color.Black;
            ...
            this.gpgPanelConflicts.Size = new Size(0x285, 0x30);
            ...
            this.gpgLabel9.Size = new Size(0x2d7, 0x11);
            ...
            base.Name = "PnlModDetailsView";
            base.Size = new Size(0x2db, 0x189);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            ThreadPool.QueueUserWorkItem(delegate (object state) {
                try
                {
                    ...
                    Dictionary<string, GPG.Multiplayer.Client.Vaulting.Mods.Mod> MyMods = new Dictionary<string, GPG.Multiplayer.Client.Vaulting.Mods.Mod>(AdditionalContent.MyContent.Count);
                    foreach (IAdditionalContent content in AdditionalContent.MyContent)
                    {
                        if (content is GPG.Multiplayer.Client.Vaulting.Mods.Mod)
                        {
                            GPG.Multiplayer.Client.Vaulting.Mods.Mod mod2 = content as GPG.Multiplayer.Client.Vaulting.Mods.Mod;
                            MyMods[mod2.Guid] = mod2;
                        }
                    }
                    int top = 0;
                    VGen0 method = null;
                        ...
                        if ((requirement != null) && (requirement.Length >= 1))
                        {
                            if (method == null)
                            {
                                method = delegate {
                                    ...
                                    {
                                        if (!GPG.Multiplayer.Client.Vaulting.Mods.Mod.CachedModLookups.ContainsKey(requirement))
                                        {
                                        ...
                                        {
                                            label.Text = string.Format("Required mod not in vault, UID: {0}", requirement);
                        ...
                        if ((conflict != null) && (conflict.Length >= 1))
                        {
                            if (gen2 == null)
                            {
                                gen2 = delegate {
                                    ...
                                    {
                                        if (!GPG.Multiplayer.Client.Vaulting.Mods.Mod.CachedModLookups.ContainsKey(conflict))
                                        {
                                        ...
                                        {
                                            label.Text = string.Format("Conflicting mod not in vault, UID: {0}", conflict);
                                            label.TextStyle = TextStyles.Default;
                                        }
                                    }
                                    label.Left = 0;
